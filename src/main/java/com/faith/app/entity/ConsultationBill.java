...
public class ConsultationBill {
	...
	public ConsultationBill(int billId, int appoinId, Appointment appointment, double billAmount, String isActive,
	...
	public String toString() {
		return "ConsultationBill [billId=" + billId + ", appoinId=" + appoinId + ", appointment=" + appointment
